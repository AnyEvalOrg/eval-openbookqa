#!/usr/bin/env python3
"""Run ONE problem of openbookqa through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one openbookqa problem via TrustedRouter")
